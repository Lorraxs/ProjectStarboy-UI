...
export interface IColorVehilce {
  ID: string;
  Description: string;
  Hex: string;
  RGB: string;
...
export const DefaultVehicleColor: IColorVehilce[] = [
  {
    ID: "0",
...
export const VehicleListOnCategory = {
  ...
  Sports: ["banshee", "comet4", "coquette4", "elegy2"],
  Muscles: ["dominator", "hustler", "clique", "deviant"],
  SuperCar: ["adder", "autarch", "taipan", "tempesta"],
  SUVs: ["baller", "bjxl", "cavalcade", "contender"],
  Vans: ["bison", "gburrito", "bobcatxl", "minivan"],
  Addons: ["mec", "bmw", "audi", "ferrari"],
  Motocycles: ["akuma", "avarus", "bagger", "bati"],
  Boats: ["dinghy", "jetmax", "marquis", "seashark"],
  Planes: ["havok", "frogger2", "maverick", "savage"],
};

export const DefaultVehicleShopInfomation: { [key: string]: IVehicleShop } = {
  asea: {
    title: "DeclasseAsea",
    price: 100000,
    description: "loremsdsda",
    type: "car",
    brand: "mec",
    speed: 123,
    brake: 10,
